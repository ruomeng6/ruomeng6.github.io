...
In general, I am commited to explore the complex issues under the transformative nature of today's high-choice media environment. In my high school days, although there's an intense competition and an "ultimate" goal called "Gaokao", when faced with complex questions(e.g. Conic section problems require a lot of calculations), my math teacher always told us that "making choice is much more important than making efforts". Choice as a most basic elements of the societal process needs more attention, especially at the time when there seems to be rich in options, and I'm interested in understanding how people make decisions in the media saturated situation and how these choices are shaped as the result.
